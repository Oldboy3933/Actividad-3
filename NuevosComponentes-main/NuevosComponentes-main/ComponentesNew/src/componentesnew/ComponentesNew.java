...
public class ComponentesNew extends JFrame{
    ...
    public void AddComponentes(JPanel panel1){
        ...
        radio1.setText("Bueno"); // confiuramos el valor de radio mediante el metodo setText
        panel1.add(radio1);
        radio2.setBounds(100, 130, 80, 30);
        radio2.setText("Regular");
        panel1.add(radio2);
        radio3.setBounds(200, 130, 80, 30);
        radio3.setText("Malo");
        panel1.add(radio3);
        ...
        check1.setBounds(100, 200, 20, 20);
        check1.setText("Check 1");
        panel1.add(check1);
        
        
        //ComboBox o lista desplegable 
        combolista.setBounds(100, 50, 30, 30); 
